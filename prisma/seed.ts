...
import { PrismaClient, UserRole, EstadoEmpresa, TipoAcceso, Periodicidad, EstadoObligacion, PeriodoNomina, TipoNovedad } from '@prisma/client'
import { PrismaPg } from '@prisma/adapter-pg'
import bcrypt from 'bcryptjs'

const connectionString = process.env.DATABASE_URL || 'postgresql://postgres:postgres123@localhost:5432/outsorsing_db'
...
async function main() {
  ...
  const xtours = await prisma.empresa.upsert({
    ...
    create: {
      ...
      nit: '901234567',
      dv: '8',
      direccion: 'Cra 15 No. 93-47 Of. 301',
      ciudad: 'Bogotá',
      departamento: 'Cundinamarca',
      telefono: '6015551234',
      correo: 'contabilidad@xtours.com.co',
      estado: EstadoEmpresa.ACTIVA,
      repLegalNombre: 'Xavier Ospina Mora',
      repLegalCedula: '79543210',
      repLegalCorreo: 'xavier@xtours.com.co',
      repLegalTelefono: '3001234567',
      regimen: 'Régimen Ordinario',
      responsabilidadIva: 'Responsable de IVA',
      obligadoFacturar: true,
      actividadEconomica: '7911 - Actividades de agencias de viajes',
  ...
  const diazar = await prisma.empresa.upsert({
    ...
    create: {
      ...
      nombreComercial: 'Diazar',
      nit: '800123456',
      dv: '1',
      direccion: 'Av. El Dorado No. 69-76 Of. 504',
      ciudad: 'Bogotá',
      departamento: 'Cundinamarca',
      telefono: '6015557890',
      correo: 'gerencia@diazar.com.co',
      estado: EstadoEmpresa.ACTIVA,
      repLegalNombre: 'Diana Zapata Rivera',
      repLegalCedula: '51789654',
      repLegalCorreo: 'diana@diazar.com.co',
      repLegalTelefono: '3109876543',
      regimen: 'SIMPLE',
      responsabilidadIva: 'No Responsable de IVA',
      obligadoFacturar: true,
      actividadEconomica: '4641 - Comercio al por mayor de productos textiles',
      tipoContribuyente: 'Persona Jurídica',
      agenteRetenedor: false,
      softwareContable: 'Contaplus',
      tipoNomina: 'Nómina Electrónica DIAN',
  ...
  const tresHilos = await prisma.empresa.upsert({
    ...
    create: {
      ...
      nombreComercial: '300 Hilos',
      nit: '890765432',
      dv: '5',
      direccion: 'Calle 80 No. 69B-31 Bodega 12',
      ciudad: 'Bogotá',
      departamento: 'Cundinamarca',
      telefono: '6014442211',
      correo: 'contabilidad@300hilos.com',
      estado: EstadoEmpresa.ACTIVA,
      repLegalNombre: 'Roberto Hernández Caro',
      repLegalCedula: '80234567',
      repLegalCorreo: 'roberto@300hilos.com',
      repLegalTelefono: '3156789012',
      regimen: 'Régimen Ordinario',
      responsabilidadIva: 'Responsable de IVA',
      obligadoFacturar: true,
      actividadEconomica: '1311 - Preparación e hilatura de fibras textiles',
      tipoContribuyente: 'Persona Jurídica',
      agenteRetenedor: true,
      softwareContable: 'World Office',
      tipoNomina: 'Nómina Electrónica DIAN',
      periodicidadNomina: 'Quincenal',
      tipoFacturacionElectronica: 'Habilitado',
    },
  ...
  const textilNorte = await prisma.empresa.upsert({
    ...
    create: {
      ...
      nombreComercial: 'Textiles Norte',
      nit: '900456789',
      dv: '3',
      direccion: 'Cra 43A No. 19-70 Of. 201',
      ciudad: 'Medellín',
      departamento: 'Antioquia',
      telefono: '6044321098',
      correo: 'admin@textilesnorte.com',
      estado: EstadoEmpresa.ACTIVA,
      repLegalNombre: 'Jorge Cardona Vélez',
      repLegalCedula: '71345678',
      repLegalCorreo: 'jorge@textilesnorte.com',
      repLegalTelefono: '3142345678',
      regimen: 'Régimen Ordinario',
      responsabilidadIva: 'Responsable de IVA',
      obligadoFacturar: false,
      actividadEconomica: '4641 - Comercio al por mayor textiles',
      tipoContribuyente: 'Persona Jurídica',
      agenteRetenedor: false,
      softwareContable: 'Siigo Nube',
      tipoNomina: 'Nómina Electrónica DIAN',
  ...
  const comercializadora = await prisma.empresa.upsert({
    ...
    create: {
      ...
      nombreComercial: 'ComABC',
      nit: '901987654',
      dv: '2',
      direccion: 'Cra 7 No. 32-55',
      ciudad: 'Bogotá',
      departamento: 'Cundinamarca',
      telefono: '6013334455',
      correo: 'info@comabc.co',
      estado: EstadoEmpresa.INACTIVA,
      repLegalNombre: 'Luisa Fernanda Morales',
      repLegalCedula: '52123456',
      repLegalCorreo: 'luisa@comabc.co',
      repLegalTelefono: '3001112233',
      regimen: 'SIMPLE',
      responsabilidadIva: 'No Responsable de IVA',
      obligadoFacturar: false,
      tipoContribuyente: 'Persona Jurídica',
  ...
  // ─── Cliente user for X TOURS ─────────────────────────────
  await prisma.user.upsert({
    where: { email: 'cliente@xtours.com.co' },
    update: {},
    create: {
      email: 'cliente@xtours.com.co',
      name: 'Xavier Ospina',
      password: clientPass,
  ...
  await prisma.acceso.createMany({
    ...
    data: [
      {
        empresaId: xtours.id,
        tipo: TipoAcceso.DIAN,
        plataforma: 'DIAN Muisca',
        usuario: 'xtours901234@gmail.com',
        contrasena: encodePass('Xto@2024#'),
        correoAsociado: 'xtours901234@gmail.com',
        tags: ['DIAN', 'tributario'],
        createdBy: admin.id,
      },
      {
        empresaId: xtours.id,
        tipo: TipoAcceso.PARAFISCAL,
        plataforma: 'MiPlanilla',
        usuario: 'xtours_planilla',
        contrasena: encodePass('Planilla2024*'),
        tags: ['nómina', 'parafiscales'],
        createdBy: admin.id,
      },
      {
        empresaId: xtours.id,
        tipo: TipoAcceso.SOFTWARE_CONTABLE,
        plataforma: 'Siigo Nube',
        usuario: 'contabilidad@xtours.com.co',
        contrasena: encodePass('Siigo#2024'),
        tags: ['contabilidad'],
        createdBy: admin.id,
      },
      {
        ...
        contrasena: encodePass('Diaz@2024!'),
      ...
      {
        empresaId: diazar.id,
        tipo: TipoAcceso.HACIENDA,
        plataforma: 'Secretaría de Hacienda Bogotá',
        usuario: 'DIAZAR123',
        contrasena: encodePass('Hac2024#'),
        municipio: 'Bogotá',
        tags: ['ICA', 'hacienda'],
        createdBy: admin.id,
      },
      {
        empresaId: diazar.id,
        tipo: TipoAcceso.BANCO,
        banco: 'Banco de Bogotá',
        usuario: '8001234560',
        contrasena: encodePass('BogBan@24'),
        tags: ['banco', 'pagos'],
        createdBy: admin.id,
      },
      {
        empresaId: tresHilos.id,
        tipo: TipoAcceso.DIAN,
        plataforma: 'DIAN Muisca',
        usuario: 'contabilidad@300hilos.com',
        contrasena: encodePass('H1l0s#2024'),
      ...
      },
      {
        ...
        tipo: TipoAcceso.HACIENDA,
        plataforma: 'Secretaría de Hacienda Bogotá',
        usuario: 'HILOS300_BOG',
        contrasena: encodePass('Ica#2024'),
        municipio: 'Bogotá',
        tags: ['ICA'],
        createdBy: admin.id,
      },
  ...
  await prisma.obligacionTributaria.createMany({
    ...
    data: [
      ...
      { empresaId: xtours.id, tipoObligacion: 'FONTUR', periodicidad: Periodicidad.TRIMESTRAL, periodo: '2', año: 2026, fechaVencimiento: d(22), estado: EstadoObligacion.PENDIENTE, municipio: 'Nacional', responsableId: analista.id },
      ...
      { empresaId: tresHilos.id, tipoObligacion: 'ReteICA Bogotá', periodicidad: Periodicidad.BIMESTRAL, periodo: '3', año: 2026, fechaVencimiento: d(16), estado: EstadoObligacion.PENDIENTE, municipio: 'Bogotá', responsableId: analista.id },
  ...
  // ─── Empleados 300 HILOS ──────────────────────────────────
  const empleados300 = [
    { cedula: '52107968', nombre: 'DÍAZ MONTERROSO LUZ MARINA', ciudad: 'Bogotá' },
    { cedula: '1015419117', nombre: 'COLÓN TORRES ANDRES FELIPE', ciudad: 'Bogotá' },
    { cedula: '1015623080', nombre: 'MELO FONSECA ETA VANESSA', ciudad: 'Bogotá' },
    { cedula: '1014134193', nombre: 'GARZÓN URREGO JOYENTH ANGÉLICA', ciudad: 'Bogotá' },
    { cedula: '80402490', nombre: 'MIRABUENA COLLAZOS JHON', ciudad: 'Bogotá' },
    { cedula: '52321205', nombre: 'MANCÍA NIÑO PILAR', ciudad: 'Bogotá' },
    { cedula: '1032321201', nombre: 'CORTÉS UNICA JINNSY', ciudad: 'Bogotá' },
    { cedula: '1019190730', nombre: 'HERNÁNDEZ SANABRIA ÁNGELA MILENA', ciudad: 'Bogotá' },
    { cedula: '1026739725', nombre: 'GARZÓN LOMBANA MARÍA ALEJANDRA', ciudad: 'Bogotá' },
    { cedula: '1014186120', nombre: 'QUINTERO TRIANA ÁNGELA PATRICIA', ciudad: 'Bogotá' },
  ]

  for (const emp of empleados300) {
    await prisma.empleado.upsert({
      where: { empresaId_cedula: { empresaId: tresHilos.id, cedula: emp.cedula } },
      update: {},
